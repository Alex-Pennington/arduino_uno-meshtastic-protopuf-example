...
bool handle_node_info(meshtastic_NodeInfo *nodeInfo, pb_byte_t * user_id, pb_byte_t * long_name,
...
bool handle_packet(uint32_t now, size_t payload_len) {
  ...
  switch (fromRadio.which_payload_variant) {
    ...
    case meshtastic_FromRadio_node_info_tag:
      return handle_node_info(&fromRadio.node_info, user_id, long_name, short_name, macaddr);
